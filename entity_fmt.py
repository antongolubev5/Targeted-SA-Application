class EntityFormatter(object):
    """ Форматирование типов сущностей в тексте.
        ...
        NOTE: Предполагается из них использовать только то множество, которое
        преимущественно попадает под возможность разметки большинством
        или наиболее полулярными NER моделями.
    """
